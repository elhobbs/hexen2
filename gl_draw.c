...
void Draw_Init (void)
{
	...
	trans = (unsigned *)malloc(sizeof(unsigned) * 640 * 480);
...
void Draw_Character (int x, int y, unsigned int num)
{
	...
	verts[1].xyz[1] = YPOS(y);
	verts[1].xyz[2] = 0;
	verts[1].st[0] = fcol + xsize;
	verts[1].st[1] = frow;
	verts[1].n[0] = verts[1].n[1] = verts[1].n[2] = 1.0f;
	memcpy(verts[1].c, light, 16);

	verts[2].xyz[0] = x + 8;
	verts[2].xyz[1] = YPOS(y + 8);
	verts[2].xyz[2] = 0;
	verts[2].st[0] = fcol + xsize;
	verts[2].st[1] = frow + ysize;
	verts[2].n[0] = verts[2].n[1] = verts[2].n[2] = 1.0f;
	memcpy(verts[2].c, light, 16);
...
void Draw_TransPicTranslate (int x, int y, qpic_t *pic, byte *translation)
{
	...
	verts[1].xyz[1] = YPOS(y);
	verts[1].xyz[2] = 0;
	verts[1].st[0] = (float)PLAYER_PIC_WIDTH / PLAYER_DEST_WIDTH;
	verts[1].st[1] = 0;
	verts[1].n[0] = verts[1].n[1] = verts[1].n[2] = 1.0f;
	memcpy(verts[1].c, light, 16);
	...
	verts[2].xyz[1] = YPOS(y + h);
	verts[2].xyz[2] = 0;
	verts[2].st[0] = (float)PLAYER_PIC_WIDTH / PLAYER_DEST_WIDTH;
	verts[2].st[1] = (float)PLAYER_PIC_HEIGHT / PLAYER_DEST_HEIGHT;
	verts[2].n[0] = verts[2].n[1] = verts[2].n[2] = 1.0f;
	memcpy(verts[2].c, light, 16);
	...
	verts[3].xyz[2] = 0;
	verts[3].st[0] = 0;
	verts[3].st[1] = (float)PLAYER_PIC_HEIGHT / PLAYER_DEST_HEIGHT;
	verts[3].n[0] = verts[3].n[1] = verts[3].n[2] = 1.0f;
	memcpy(verts[3].c, light, 16);
...
#else
	glMatrixMode(GL_PROJECTION);
	initOrthoMatrix(vid.width, vid.height, -1.0f, 1.0f);
