...
//
	waitforit("SCR_SetUpToDrawConsole");
	SCR_SetUpToDrawConsole ();
	...
	//
	waitforit("SCR_TileClear");
	SCR_TileClear ();

	if (scr_drawdialog)
	{
		waitforit("scr_drawdialog");
		SB_Draw();
		Draw_FadeScreen ();
	...
	{
		waitforit("SB_IntermissionOverlay");
		SB_IntermissionOverlay();
